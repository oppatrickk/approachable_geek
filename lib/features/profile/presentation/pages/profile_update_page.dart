  ...
  Widget buildSections(ProfileItemType profileItemType) {
    switch (profileItemType) {
      case ProfileItemType.name:
        return ProfileUpdateNameSection(user: user);
      case ProfileItemType.phone:
        return ProfileUpdatePhoneSection(user: user);
      case ProfileItemType.email:
        return ProfileUpdateEmailSection(user: user);
      case ProfileItemType.about:
        return ProfileUpdateAboutSection(user: user);
      case ProfileItemType.photo:
        return ProfileUpdatePhotoSection(user: user);
    }
  }
}
